...
import {
  ...
  Thermometer, Droplets, Wind, TreePine, Clock
} from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Monitored Zones</h1>
          <p className="text-sm text-slate-400 mt-1">{zones.length} zones being monitored</p>
        </div>
