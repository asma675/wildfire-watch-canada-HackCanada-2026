...
export default function HealthPrecautions() {
  const [open, setOpen] = useState("symptoms");

  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Health Precautions & Smoke Impact</h1>
        <p className="text-sm text-slate-400 mt-1">Understanding the health risks and how to protect yourself</p>
      </div>
