...
import {
  Plus, Radio, AlertTriangle, Heart, Loader2, X, Activity, Cpu, ShieldAlert, Wifi, Map, BarChart2
} from "lucide-react";
...
export default function DronesContent() {
    ...
    <div className="h-full flex flex-col lg:flex-row">
      <div className="flex-1 overflow-hidden flex flex-col">
        <div className="px-5 py-4 border-b border-white/5">
          <p className="text-xs text-slate-500">Wildfire reconnaissance · Search & rescue · Health monitoring</p>
        </div>
