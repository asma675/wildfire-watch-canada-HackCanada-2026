...
export default function AIIntelligenceContent() {
  ...
  const getVoiceIdForLanguage = (language) => {
    const voiceMap = {
      ...
      Spanish: 'IKne3meq5KwVNHVAmeWl',
      French: 'gSvkkqnULapFVHVN55a3',
      Russian: 'LZw821naxvyAUzlsPXeO',
      Ukrainian: 'Xb7hH8MSUJpSbvqL51Co',
      Hindi: 'nPczCjzI2devNBz1zQrb'
    };
    ...
    <div className="min-h-screen bg-[#0f0f1a] p-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white mb-2">Wildfire AI Assistant</h2>
